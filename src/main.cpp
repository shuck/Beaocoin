...
uint256 hashGenesisBlock("0xca6228129efc24e9ddc80de984e46d1eb01bdff08bc5d2da15d8392da826ed2c");
...
const string strMessageMagic = "BeaoCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 1 * 10 * 60; // BeaoCoin: 10 minutes
static const int64 nTargetSpacing = 60; // BeaoCoin: 1 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal BeaoCoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "BeaoCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xf631176d2b5b88cd9f948ffd475fcd66a6e56095c286fa5d11478d2ea2f9b32a");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Love life and love BeaoCoin";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1378900800; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 4747798;

        if (fTestNet)
        {
            block.nTime    = 1378893600;
            block.nNonce   = 2279044;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x76dc44381fd5886e94e37846f8062937c14fdcd1cd4083630a1e4c2a82ff1183"));
